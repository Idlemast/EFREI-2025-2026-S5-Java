...
public class Main {
	...
	System.out.format("%s%n%n", "Pour l'instant il n'y a aucun rendez-vous ajouté au planning, donc ajoutons un rendez-vous");
	etablissement1.ajouter(client1, LocalDateTime.now().plusDays(6).withHour(10).withMinute(0), PrestationExpress.CategorieVehicule.A, true);
	System.out.format("%s", etablissement1.printPlanning());
	...
	System.out.format(etablissement1.afficher(DayOfWeek.TUESDAY));
	System.out.format(etablissement1.afficher(DayOfWeek.WEDNESDAY));
